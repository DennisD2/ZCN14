...
#* change log
#
# 2020 Nov 27 - fixed unnecessary 8080 substitutions (see ChangeLog).
# 2020 Nov 23 - fixed surprisingly obvious bug in "sra".
...
if($1=="sla")
  ...
  print "ld " savereghi ",a"
  print "rla"			# bit 7 -> carry
  print "ld a," savereghi	# restore A
  print "rra"
