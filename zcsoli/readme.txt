...
CP/M 2.2 does), but it's slower and larger. [ZCN only comes with
zcsoli.com.]
...
By default, zcsoli.com expects a VT100/ANSI terminal. [Or in this
modified version, ZCN.] But you can specify a builtin terminal type to
use by running it with "zcsoli n" where n is:

0  custom terminal as patched-in [ZCN (NC100)]
1  VT100
2  VT52
3  ZCN [NC200]
4  VC404
...
For ZCN, use "zcsoli 0" on NC100 and "zcsoli 3" on NC200. [Not
required by this modified version, but it still works.] Both
